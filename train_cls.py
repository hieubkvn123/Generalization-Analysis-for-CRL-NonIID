...
if __name__ == '__main__':
    ...
    if os.path.exists(IND_INDICES):
        with open(IND_INDICES, 'rb') as f:
            ind_indices = list(pickle.load(f))
        train_data = torch.utils.data.Subset(train_data, ind_indices)
        print(f'[INFO] Independent indices loaded from {IND_INDICES}')
