#!/bin/bash
python3 train.py --dataset mnist --k 1 --outfile results/ablation_study_iid_vs_noniid_mnist.csv --batch_size 10 --M 100 --regime independent --train_loss_thresh 0.0001
